...
\begin{document}
  ...
  \section{課題1}
   ...
   \subsection{線形変換の結果}
     ...
     また、一枚の画像内にどのような画素値が含まれているかの分布を表した濃淡ヒストグラムで表す。図\ref{fig:wman-g}のヒストグラムを図\ref{fig:sen_defa_hist}に、
     \begin{figure}[H]
      \centering
      % 上段
      \begin{minipage}{0.45\textwidth}
  ...
  \section{課題2}
   \subsection{実験内容}
    ...
    \begin{figure}[H]
      ...
      \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{02_image/woman_spike.jpg}
        \caption{スパイクノイズ画像}
